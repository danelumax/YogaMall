	...
	var REGISTER={
		...
		inputcheck:function(){
				...
				if ($("#pwd").val() != $("#pwdRepeat").val()) {
					...
					$("#pwdRepeat").select(); //将pwdRepeat编辑框内的值，选中
					$("#pwdRepeat").focus();
					return false;
				}
				return true;
		...
		login:function() {
			 location.href = "/page/login"; //跳转到登录页面
			 return false;
		},
		reg:function() {
			if (this.inputcheck()) {
